...
function checkPassword() {
    ...
    // Get user input
    const userInput = document.getElementById('password').value.trim(); // Remove any accidental spaces

    console.log("Entered password:", userInput); // Debugging output to check what's entered
